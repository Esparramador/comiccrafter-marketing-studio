...
import { ChevronLeft, ChevronRight, Loader2, LayoutGrid, Columns } from "lucide-react";
        ...
        <div className="flex flex-col gap-4 flex-1">
          ...
          <div className="flex items-center justify-between bg-[var(--surface-raised)] border border-[var(--border-dim)] rounded-2xl px-5 py-3">
            ...
            <div className="text-center">
              ...
              {gcalLoading && <p className="text-xs text-gray-500 flex items-center gap-1 justify-center mt-0.5"><Loader2 className="w-3 h-3 animate-spin" />Cargando...</p>}
              {!gcalLoading && <p className="text-xs text-gray-500 mt-0.5">{gcalData?.length || 0} eventos</p>}
            </div>
